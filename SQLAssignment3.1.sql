...
select distinct salary from worker ORDER BY salary DESC limit 4,1; -- 5th highest salary
select * from worker where salary=(select distinct salary from worker ORDER BY salary DESC limit 4,1); -- For records of 5th highest salary 
